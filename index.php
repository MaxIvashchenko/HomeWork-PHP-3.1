...
<p>Инкапсуляция позволяет выводить данные систематичски, а также защищает от внешнего влияния вмешательства или несанкционированного использования.</p>
<p>Плюсы:</p>
<ul>
...
class TV 
{
    ...
    public function __construct ($modelTV, $screenSize, $tecnology) {
        ...
        echo "<pre>";
        echo "На наличии модели телевизоров " . $this->modelTV . " диагональю " . $this->screenSize . "'' с технологией: " . $this->tecnology;
        echo "</pre>";
    }
...
class goods 
{
    ...
    public function __construct ($name, $wasMade, $quality) 
    {
        ...
        echo "<pre>";
        echo $this->name . " имеет " . $this->quality . " качество. Сдеално в " . $this->wasMade;
        echo "</pre>";
    }
